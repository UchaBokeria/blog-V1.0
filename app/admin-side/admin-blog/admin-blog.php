<div id="admin-blog">
    ...
    <div class="exhibition-posts">
        ...
        <div class="post-edit-delete">
            <i class="material-icons" id="blog_edit" data-id="1">edit</i>
            <i class="material-icons" id="blog_delete"  data-id="1">delete</i>
        </div>
        <i class="fa fa-angle-down" id="blog_show_more" data-id="1"></i>
